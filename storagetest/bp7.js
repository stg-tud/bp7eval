...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "bp7.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "bp7.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'bp7'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'bp7':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        ...
        initialize: function( instance ) {
            ...
            Module.exports.new_std_bundle_now = function new_std_bundle_now(src, dst, payload) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.new_std_bundle_now(Module.STDWEB_PRIVATE.prepare_any_arg(src), Module.STDWEB_PRIVATE.prepare_any_arg(dst), Module.STDWEB_PRIVATE.prepare_any_arg(payload)));
}
;
                Module.exports.rnd_bundle_now = function rnd_bundle_now() {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.rnd_bundle_now());
}
;
                Module.exports.encode_to_cbor = function encode_to_cbor(b) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.encode_to_cbor(Module.STDWEB_PRIVATE.prepare_any_arg(b)));
}
;
                Module.exports.decode_from_cbor = function decode_from_cbor(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.decode_from_cbor(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
                Module.exports.bid_from_bundle = function bid_from_bundle(b) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.bid_from_bundle(Module.STDWEB_PRIVATE.prepare_any_arg(b)));
}
;
                Module.exports.bid_from_cbor = function bid_from_cbor(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.bid_from_cbor(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
                Module.exports.payload_from_bundle = function payload_from_bundle(b) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.payload_from_bundle(Module.STDWEB_PRIVATE.prepare_any_arg(b)));
}
;
                Module.exports.payload_from_cbor = function payload_from_cbor(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.payload_from_cbor(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
                Module.exports.valid_bundle = function valid_bundle(b) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.valid_bundle(Module.STDWEB_PRIVATE.prepare_any_arg(b)));
}
;
                Module.exports.valid_cbor = function valid_cbor(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.valid_cbor(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
                Module.exports.sender_from_bundle = function sender_from_bundle(b) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.sender_from_bundle(Module.STDWEB_PRIVATE.prepare_any_arg(b)));
}
;
                Module.exports.sender_from_cbor = function sender_from_cbor(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.sender_from_cbor(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
                Module.exports.recipient_from_bundle = function recipient_from_bundle(b) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.recipient_from_bundle(Module.STDWEB_PRIVATE.prepare_any_arg(b)));
}
;
                Module.exports.recipient_from_cbor = function recipient_from_cbor(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.recipient_from_cbor(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
                Module.exports.timestamp_from_bundle = function timestamp_from_bundle(b) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.timestamp_from_bundle(Module.STDWEB_PRIVATE.prepare_any_arg(b)));
}
;
                Module.exports.timestamp_from_cbor = function timestamp_from_cbor(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.timestamp_from_cbor(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
                Module.exports.bundle_is_administrative_record = function bundle_is_administrative_record(b) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.bundle_is_administrative_record(Module.STDWEB_PRIVATE.prepare_any_arg(b)));
}
;
                Module.exports.cbor_is_administrative_record = function cbor_is_administrative_record(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.cbor_is_administrative_record(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
            __web_on_grow();
